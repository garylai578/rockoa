...
function _mobiscrolldate_select(ids, opts, lx){
	var opt={};
	...
	var obj = $('#'+ids+'');
	if(lx==0){
		obj.mobiscroll($.extend(optDateTime,opts));
	}
	if(lx==1){
		obj.mobiscroll($.extend(optDate,opts));
	}
	if(lx==2){
		obj.mobiscroll($.extend(optTime,opts));
	}
	return obj;
}
function mobiscrolldatetime(ids,opts){
	return _mobiscrolldate_select(ids, opts, 0);
}
function mobiscrolldate(ids,opts){
	return _mobiscrolldate_select(ids, opts, 1);
}
function mobiscrolltime(ids,opts){
	return _mobiscrolldate_select(ids, opts, 2);
}