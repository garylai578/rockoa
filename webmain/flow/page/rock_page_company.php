...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"名称",dataIndex:"name",align:"left"},{text:"对应负责人",dataIndex:"fuzename"},{text:"所在城市",dataIndex:"city"},{text:"地址",dataIndex:"address",align:"left"},{text:"电话",dataIndex:"tel"},{text:"传真",dataIndex:"fax"},{text:"排序号",dataIndex:"sort"},{text:"开户银行",dataIndex:"bank"},{text:"开户户名",dataIndex:"account"},{text:"开户帐号",dataIndex:"accountNum"},{text:"ID",dataIndex:"id"},{
