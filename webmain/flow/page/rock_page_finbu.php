...
$(document).ready(function(){
	{params}
	var modenum = 'finbu',modename='发票补录',isflow=1,modeid='74',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"datetime","ispx":"1","isalign":"0","islb":"1"},{"fields":"bills","name":"\u9644\u5355\u636e(\u5f20)","fieldstype":"number","ispx":"0","isalign":"0","islb":"0"},{"fields":"num","name":"\u5408\u540c\u53f7\/\u8ba2\u5355\u53f7","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"1","isalign":"0","islb":"1"},{"fields":"piaonum","name":"\u7968\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"openpiaotype","name":"\u662f\u5426\u542b\u7a0e\u7968","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"projectName","name":"\u9879\u76ee\u540d\u79f0","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"},{"fields":"company","name":"\u6240\u5c5e\u516c\u53f8","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"buyer","name":"\u91c7\u8d2d\u5355\u4f4d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'发票补录('+nowtabs.name+')',
				cont:'发票补录('+nowtabs.name+')的列表的',
				explain:'订阅[发票补录]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finbu|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinbu = a;
			addtabs({num:'daorufinbu',url:'flow,input,daoru,modenum=finbu',icons:'plus',name:'导入发票补录'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"base_name",sortable:true},{text:"申请人部门",dataIndex:"base_deptname",sortable:true},{text:"单号",dataIndex:"sericnum"},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"金额",dataIndex:"money",sortable:true},{text:"票号",dataIndex:"piaonum"},{text:"是否含税票",dataIndex:"openpiaotype"},{text:"付款方式",dataIndex:"paytype"},{text:"项目名称",dataIndex:"projectName"},{text:"所属公司",dataIndex:"company"},{text:"采购单位",dataIndex:"buyer"},{text:"说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinbu_{rand}').bootstable(bootparams);
	c.init();
...
<div>
	...
	<tr>
		...
		<td style="padding-left:10px"><select class="form-control" style="width:120px" id="selstatus_{rand}"><option value="">-全部状态-</option><option style="color:blue" value="0">待处理</option><option style="color:green" value="1">已抵扣</option><option style="color:red" value="2">退回处理中</option><option style="color:#ff6600" value="3">待抵扣</option><option style="color:#888888" value="5">已作废</option><option style="color:#17B2B7" value="23">退回</option></select></td>
