...
*	来源：流程模块→表单元素管理→[模块.待收发票管理]→生成列表页
*/
...
$(document).ready(function(){
	...
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"type","name":"\u7c7b\u578b","fieldstype":"fixed","ispx":"0","isalign":"0","islb":"0"},{"fields":"buyer","name":"\u91c7\u8d2d\u5355\u4f4d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"paytype","name":"\u4ed8\u6b3e\u65b9\u5f0f","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"bills","name":"\u9644\u5355\u636e(\u5f20)","fieldstype":"number","ispx":"0","isalign":"0","islb":"0"},{"fields":"piaonum","name":"\u7968\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"kpdt","name":"\u5f00\u7968\u65e5\u671f","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"},{"fields":"purpose","name":"\u6765\u6e90","fieldstype":"rockcombo","ispx":"1","isalign":"0","islb":"1"},{"fields":"tel","name":"\u8054\u7cfb\u65b9\u5f0f","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"contact","name":"\u8054\u7cfb\u4eba","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"openpiaotype","name":"\u662f\u5426\u542b\u7a0e\u7968","fieldstype":"rockcombo","ispx":"0","isalign":"0","islb":"1"},{"fields":"money","name":"\u91d1\u989d","fieldstype":"number","ispx":"0","isalign":"0","islb":"1"},{"fields":"company","name":"\u7968\u5c5e\u516c\u53f8","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"num","name":"\u5408\u540c\u53f7\/\u8ba2\u5355\u53f7","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'待收发票管理('+nowtabs.name+')',
				cont:'待收发票管理('+nowtabs.name+')的列表的',
				explain:'订阅[待收发票管理]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_finlai|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistfinlai = a;
			addtabs({num:'daorufinlai',url:'flow,input,daoru,modenum=finlai',icons:'plus',name:'导入待收发票管理'});
		},
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"采购单位",dataIndex:"buyer"},{text:"付款方式",dataIndex:"paytype"},{text:"票号",dataIndex:"piaonum"},{text:"开票日期",dataIndex:"kpdt"},{text:"来源",dataIndex:"purpose",sortable:true},{text:"联系方式",dataIndex:"tel"},{text:"联系人",dataIndex:"contact"},{text:"是否含税票",dataIndex:"openpiaotype"},{text:"金额",dataIndex:"money"},{text:"票属公司",dataIndex:"company"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewfinlai_{rand}').bootstable(bootparams);
	c.init();
