...
$(document).ready(function(){
	{params}
	var modenum = 'quote',modename='报价单',isflow=0,modeid='77',atype = params.atype,pnum=params.pnum;
	if(!atype)atype='';if(!pnum)pnum='';
	var fieldsarr = [{"name":"\u7533\u8bf7\u4eba","fields":"base_name"},{"name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fields":"base_deptname"},{"name":"\u5355\u53f7","fields":"sericnum"},{"fields":"quotedt","name":"\u62a5\u4ef7\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"listid","name":"\u62a5\u4ef7\u5355\u53f7","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"custname","name":"\u5ba2\u6237\u540d\u79f0","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"custid","name":"\u5ba2\u6237id","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"receiver","name":"\u6536\u4ef6\u4eba","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"receviertel","name":"\u6536\u4ef6\u4eba\u7535\u8bdd","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"from","name":"\u53d1\u4ef6\u4eba","fieldstype":"select","ispx":"0","isalign":"0","islb":"0"},{"fields":"fromtel","name":"\u53d1\u4ef6\u4eba\u7535\u8bdd","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"company","name":"\u62a5\u4ef7\u516c\u53f8","fieldstype":"selectdatafalse","ispx":"0","isalign":"0","islb":"1"},{"fields":"companyid","name":"\u62a5\u4ef7\u516c\u53f8id","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"0"},{"fields":"expdt","name":"\u62a5\u4ef7\u6709\u6548\u671f","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"rate","name":"\u62a5\u4ef7\u7a0e\u7387","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"moneys","name":"\u62a5\u4ef7\u91d1\u989d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"moneyscn","name":"\u5927\u5199\u91d1\u989d","fieldstype":"text","ispx":"0","isalign":"0","islb":"0"},{"fields":"explain","name":"\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"0"},{"fields":"status","name":"\u72b6\u6001","fieldstype":"hidden","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= [];
	...
	var c = {
		...
		subscribelist:function(){
			js.subscribe({
				title:'报价单('+nowtabs.name+')',
				cont:'报价单('+nowtabs.name+')的列表的',
				explain:'订阅[报价单]的列表',
				objtable:a
			});
		},
		getacturl:function(act){
			return js.getajaxurl(act,'mode_quote|input','flow',{'modeid':modeid});
		},
		...
		daoru:function(){
			window.managelistquote = a;
			addtabs({num:'daoruquote',url:'flow,input,daoru,modenum=quote',icons:'plus',name:'导入报价单'});
		},
	...
	//表格参数设定
	var bootparams = {
		fanye:true,modenum:modenum,modename:modename,statuschange:false,tablename:jm.base64decode('cXVvdGU:'),
		url:c.storeurl(),storeafteraction:'storeaftershow',storebeforeaction:'storebeforeshow',
		params:{atype:atype},
		columns:[{text:"报价日期",dataIndex:"quotedt",sortable:true},{text:"报价单号",dataIndex:"listid"},{text:"客户名称",dataIndex:"custname"},{text:"报价公司",dataIndex:"company"},{text:"报价金额",dataIndex:"moneys"},{text:"状态",dataIndex:"status"},{
...
//[自定义区域end]
	...
	js.initbtn(c);
	var a = $('#viewquote_{rand}').bootstable(bootparams);
	c.init();
