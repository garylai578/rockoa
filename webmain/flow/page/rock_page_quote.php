...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"报价日期",dataIndex:"quotedt",sortable:true},{text:"报价单号",dataIndex:"listid"},{text:"客户名称",dataIndex:"custname"},{text:"报价公司",dataIndex:"company"},{text:"报价金额",dataIndex:"moneys"},{
