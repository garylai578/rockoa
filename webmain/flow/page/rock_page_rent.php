...
<script>
    $(document).ready(function () {
        ...
        var fieldsarr = [{
            "name": "\u7533\u8bf7\u4eba",
            "fields": "base_name"
        }, {"name": "\u7533\u8bf7\u4eba\u90e8\u95e8", "fields": "base_deptname"}, {
            "name": "\u5355\u53f7",
            "fields": "sericnum"
        }, {
            "fields": "custname",
            "name": "\u5ba2\u6237\u540d\u79f0",
            "fieldstype": "selectdatafalse",
            "ispx": "0",
            "isalign": "0",
            "islb": "1"
        }, {
            ...
            "isalign": "0",
            "islb": "1"
        }], fieldsselarr = {"columns_rent_remind": "custname,dept,rentnum,brand,model,caozuo"};
        ...
        var c = {
            ...
            initcolumns: function (bots) {
                ...
                if (nstr == '' || nstr.indexOf(',caozuo,') >= 0) d.push({
                    text: '',
                    dataIndex: 'caozuo',
                    callback: 'opegs{rand}'
                });
        ...
        var bootparams = {
            ...
            modename: modename,
            statuschange: false,
            tablename: jm.base64decode('cmVudA::'),
            url: c.storeurl(),
            storeafteraction: 'remindFilter',
            storebeforeaction: '',
            params: {atype: atype},
            columns: [{text: "客户名称", dataIndex: "custname"}, {text: "部门", dataIndex: "dept"}, {
                text: "机器品牌",
                dataIndex: "brand"
            }, {text: "机器型号", dataIndex: "model"}, {text: "租约编号", dataIndex: "rentnum"}, {
                text: "月基本租金",
                dataIndex: "rental"
            }, {text: "抄表间隔（月）", dataIndex: "interval"}, {text: "备注", dataIndex: "remark"}, {
...
<div>
    <table width="100%">
        <tr>
            <td style="padding-right:10px;" id="tdleft_{rand}" nowrap>
                <button id="addbtn_{rand}" class="btn btn-primary" click="clickwin,0" disabled type="button"><i
            ...
            <td style="padding-left:10px">
                <div style="width:85px" class="btn-group">
                    ...
                    <button class="btn btn-default" id="downbtn_{rand}" type="button"
                            style="padding-left:8px;padding-right:8px"><i class="icon-angle-down"></i></button>
                </div>
            </td>
            <td width="90%" style="padding-left:10px">
                <div id="changatype{rand}" class="btn-group"></div>
            </td>
